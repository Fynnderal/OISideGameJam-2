...
public class PlayerSounds : MonoBehaviour
{
    ...
    [SerializeField][Range(0f, 1f)] private float pistolShot = 0.5f;
    [SerializeField][Range(0f, 1f)] private float smgShot = 0.3f;
    ...
    {
        mainSource.PlayOneShot(pistolSound, pistolShot);
    }

    public void PlaySmgSound()
    {
        mainSource.PlayOneShot(smgSound, smgShot);
    }
